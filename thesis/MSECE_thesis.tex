...
an NSP pretraining task was implemented where possible\footnote{Only about half of our data is in a format that enables us to extract the turn taking
    phenomenon that is present in most air-traffic communications.} to improve its pretraining results.
