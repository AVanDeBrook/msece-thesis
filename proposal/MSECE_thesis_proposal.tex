...
\begin{document}
    ...
    \section{Deliverables \& Timeline}
        ...
        \end{table}
        \footnotetext[4]{Most likely hosted on the schools OneDrive or SharePoint (associated with my student account).}
    ...
    \newpage
    \section{Appendix A}
        % TODO: the vertical alignment is aggravating; fix if possible (this one is mostly a mismatched number of items
        %       between L/R side)
